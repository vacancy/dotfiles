...
__mappings__ = mappings.FSMappings('/',
    ...
    mappings.FSMappings('zsh',
        ...
        mappings.Link('osx_envs', '.configs/osx_envs', filters=[filters.OSXFilter()]),
        mappings.Link('linux_envs', '.configs/linux_envs', filters=[filters.LinuxFilter()]),
        mappings.Copy('local_envs', '.configs/local_envs', overwrite=False),
    desc='Config zsh.'),
    mappings.FSMappings('/',
